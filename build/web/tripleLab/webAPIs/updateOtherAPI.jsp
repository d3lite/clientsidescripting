...
<%
    ...
    if (jsonUpdateData == null) {
        ...
        if (errorMsgs.errorMsg.length() == 0) { // means db connection is ok
            ...
            System.out.println("catUpdate.jsp ready to update from this data: "
                    + jsonUpdateData);
            ...
            errorMsgs = DbCatMods.update(updateData, dbc); // this is the form level message 
            
            System.out.println("catUpdate.jsp found these errors: "
                    + jsonUpdateData);
        }
    }

...
<%
    ...
    if (userErrors.errorMsg.length() == 0) { // got open connection 
        ...
        if (emailInput.length() == 0) {
            userErrors.person_email = "Email is required";
        }
        if(passwordInput.length() == 0){
            userErrors.person_password = "Password is required";
        }
       
        // userData is an object of person data inside, 
        ...
        StringData foundUser = SearchPerson.logonFind(emailInput, passwordInput, dbc);
        if(foundUser == null){

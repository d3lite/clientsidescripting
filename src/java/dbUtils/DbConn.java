    ...
    private void connect(boolean isTemple) {
        ...
        try {
            ...
            try {              
                ...
                String url = "jdbc:mysql://localhost:3307/sp17_3344_1_tue59286?user=tue59286&password=hahshahm";
                
                // unless you are working from temple (wachman hall)
                if (isTemple) {
                    url = "jdbc:mysql://cis-linux2.temple.edu:3306/sp17_3344_1_tue59286?user=tue59286&password=hahshahm";  
                }                 
